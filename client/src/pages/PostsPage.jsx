...
export default function PostsPage() {
  ...
  const filteredPosts = posts.filter(post => {
    if (filter === 'my') return user && post.author?._id === user._id;
    if (filter === 'liked') {
      const uid = user?._id || user?.id;
  ...
  return (
    <div className="social-feed-container fade-in">
        ...
        <div className="create-post-card">
          ...
          <form onSubmit={handleCreatePost}>
            ...
            <div className="create-post-footer">
              <div className={`character-count ${content.length > 450 ? 'warning' : ''}`}>
        ...
        <div className="posts-feed">
          {postsLoading ? (
            ...
            <div className="empty-state">
              ...
              <h3>No posts yet</h3>
              <p>
                {filter === 'my' && "You haven't shared any posts yet. Start the conversation!"}
                {filter === 'liked' && "You haven't liked any posts yet. Tap the heart on posts you enjoy."}
                {filter === 'all' && "Be the first to share something amazing with the community!"}
              </p>
            </div>
          ) : (
            <>
                      ...
                      {user && post.author?._id === user._id && (
                        <div className="post-actions-menu">
                          ...
                          <div className="post-menu-dropdown">
                            <button className="post-menu-trigger">
                              <i className="fas fa-ellipsis-h"></i>
                            </button>
                          ...
                          <div className="comment-input-container">
                            ...
                            <div className="comment-actions">
                              <span className="comment-char-count">
                                {(commentText[post._id] || '').length}/500
                              </span>
                              <button
      ...
      <ConfirmationModal
        ...
        message={deleteTarget?.type === 'post' 
